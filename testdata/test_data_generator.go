...
func genEntityBinary(id string, noData bool) events.BinaryEntity {
	...
	b := events.BinaryEntity{
		...
		Features: []events.BinaryEntityFeature{
			{Name: "file_format", Type: "string", Value: "data.FileFormat"},
...
func GenEventRegister(id string) *events.PluginEvent {
	// nothing under entity as it is too annoying
	author := genPluginEntity()
