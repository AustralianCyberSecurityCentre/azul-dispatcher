...
require (
	github.com/AustralianCyberSecurityCentre/azul-bedrock/v13 v13.0.30
...
// replace github.com/AustralianCyberSecurityCentre/azul-bedrock/v13 v13.0.22 => ../azul-bedrock
